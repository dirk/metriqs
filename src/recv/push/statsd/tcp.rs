...
pub struct StatsdTcpListener<A: ToSocketAddrs> {
    collector: Collector,
    addr: A,
}

impl<A: ToSocketAddrs> StatsdTcpListener<A> {
    pub fn new(collector: Collector, addr: A) -> StatsdTcpListener<A> {
        StatsdTcpListener {
            collector,
            addr,
        }
